# ASHAA: Empowering Safety through Intelligent Automation
 ...
 Ashaa is designed to bridge the gap in emergency response. Instead of relying on manual SOS triggers, it uses real-time sensor data and voice recognition to
 detect distress automatically. 
